...
<html>
  <head>
    ...
    <?php
      ...
      $appInst = $appInstError = $closedateError = $appContact = $emailContact = $contEmail = $contEmailError = $contPhoneError = $opendateError ="";
      $credit = 0;
      $validate = 0;
      $insert_count = '';
      $internID = '';
    ...
    $query2 = "SELECT * FROM internship2 WHERE ID = $edit_record ";
      ...
      foreach ($result as $internship)
      {
        ...
        echo "Application Contact: ";
        echo $internship['ApplicationContact'];
        echo "<br>";
        
        echo "Application Email: ";
        echo $internship['ApplicationEmail'];
        echo "<br>";
   ...
   <button onclick="location.href ='admin.php'">Continue..</button>
