...
//  this.addobjects = [this.jobstsack_a,this.image,this.bootstrapCol,this.jobtitle,this.jobtitleitem,
//                     this.bootstrapClearfix,this.jobdivision,this.jobLocation,this.jobView,this.jobitemform,
//                     this.idinputfield,this.edit_btn,this.reset_btn];
//  for(var i in this.addobjects){
//    this.jobcontainer_li.appendChild(this.addobjects[i]);
//  }
  this.jobtitle.appendChild(this.jobtitleitem);
